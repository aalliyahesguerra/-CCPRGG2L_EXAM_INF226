...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("[^\\W[^sgr]]{8,}");
        ...
        // 3. The length of the email prefi xshould be at least 10 characters if the
        ...
        pattern = Pattern.compile("[a-zA-Z18_\\.]{10,}@gmail\\.com$");
        ...
        // Provide the regex pattern
        tweet = tweet.replaceAll("(https?:\\/\\/)?([\\w\\.]+)([\\/\\w]{1,})$", "");
